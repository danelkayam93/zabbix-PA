...
sed -i "s/Server=127.0.0.1/Server=10.1.1.179/" /etc/zabbix/zabbix_agentd.conf
sed -i "s/ServerActive=127.0.0.1/ServerActive=10.1.1.179/" /etc/zabbix/zabbix_agentd.conf
